 ...
 *
 */
Probability Wise2_crude_normal_probability(double mean, double sd,double measure);
#define crude_normal_probability Wise2_crude_normal_probability
 ...
 *
 */
Probability Wise2_crude_normal_probability_above_0(double zscore);
#define crude_normal_probability_above_0 Wise2_crude_normal_probability_above_0
