...
#endif   
    int type;    
    BaseMatrixIntType ** matrix;    /*  NB i,j proper */ 
 ...
 *
 */
BaseMatrix * Wise2_BaseMatrix_alloc_matrix_specials_score_offset(int len_point,int len_array,int len_spec_point,int len_spec_array);
#define BaseMatrix_alloc_matrix_specials_score_offset Wise2_BaseMatrix_alloc_matrix_specials_score_offset
